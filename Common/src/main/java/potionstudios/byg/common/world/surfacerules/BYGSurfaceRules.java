...
public class BYGSurfaceRules {
    ...
    public static final SurfaceRules.RuleSource OVERWORLD_SURFACE_RULES = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(BYGBiomes.WINDSWEPT_DUNES), new BYGRuleSources.WriteCavePositions()), ABOVE_PRELIMINARY_SURFACE);
